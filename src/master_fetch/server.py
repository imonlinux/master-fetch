...
HOUND_INSTRUCTIONS = (
    ...
    "  - Rerank: options={mode:'neural'} uses a local neural cross-encoder (needs hound-mcp[all]; auto-detects). Default 'auto' picks neural if available else keyword BM25.\n"
