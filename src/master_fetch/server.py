    ...
    def serve(self, http: bool = False, host: str = "127.0.0.1", port: int = 8765):
        ...
        server.add_tool(self.smart_fetch, title="smart_fetch",
            description=(
                ...
                "Content over 40KB is chunked: when is_truncated=True, call again with offset to get the next chunk. "
                "Results are cached (1hr default). Set cache_ttl=0 to force a fresh fetch."
            ),
